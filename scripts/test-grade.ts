...
const TEST_SAMPLES = [
  {
    ...
    "description": "A change merged to upstream LLVM Git yesterday for LLVM 23 is moving AMD's HIP to using the new/modern offload driver by default...",
  ...
  },
  {
    ...
    "description": "Python 3.13 brings significant performance improvements to the interpreter...",
